...
const Subscribe = () => {
    return (
        ...
        <div className='bg-sky-900  h-[450px]'>
            ...
            <div className=' '>
                ...
                <div className='text-center  text-white '>
                    <h3 className='mb-1 font-bold text-2xl'>Save time, save money!</h3>
                    <p>Sign up and we'll send the best deals to you</p>
                </div>
                <form className='text-center mt-5 '>
                    <input  className='p-3 w-80  rounded' placeholder='Your Email Address' type="text" />
                    <input className=' ml-2 font-bold duration-500 bg-blue-500 text-white  hover:bg-blue-600 p-3 px-14 rounded' value="Subscribe" type="submit" />
                </form>
            </div>
