            ...
            <div className='absolute top-[70px] md:top-40 mx-6'>
                <div className='gap-10 md:gap-40 grid grid-cols-1 md:grid-cols-2 '>
                    ...
                    <div className='text-white text-opacity-80'>
                        ...
                        <p className='my-5 font-thin text-[17px] mb-10'>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
