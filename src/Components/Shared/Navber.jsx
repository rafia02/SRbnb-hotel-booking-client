...
const Navber = () => {
    ...
    const manueBar = <>
        <Link to="/" className='px-1 text-sm hover:text-[#c45045] duration-300 mb-2 md:mb-0 mr-2 font-semibold'>Home</Link>
        <Link to="/hotels" className='px-1 text-sm font-semibold hover:text-[#c45045] duration-300 mr-2 mb-2 md:mb-0'>Hotels</Link>
    ...
    const manueBar2 = <>
        <Link to="/analysis" className='px-1 hover:text-[#c45045] duration-300 mb-2 md:mb-0 mr-2 text-[17px]'>Faq</Link>
        <Link to="/explore" className='px-1 hover:text-[#c45045] duration-300 mb-2 md:mb-0 text-[17px]'>Explore</Link>
        ...
        <div className=' shadow-sm md:mx-3 md:py-2 '>
            <div className="navbar">
                ...
                <div className="navbar-end">
                    ...
                    {
                        user?.email ?
                            <button onClick={handleLogout} className='px-1 hover:text-[#c45045] duration-300  mr-2 mb-2 md:mb-0  text-sm font-semibold'>Logout</button>
                            :

                            <Link to="/login" className='px-1 hover:text-[#c45045] duration-300  mr-2 mb-2 md:mb-0 text-sm font-semibold'>Login</Link>
