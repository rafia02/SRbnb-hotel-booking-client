...
const Footer = () => {
  return (
    ...
    <div className='bg-sky-950 '>
      ...
      <footer className="footer bg-sky-950 text-white bg-opacity-10 px-10 py-4 border-t   border-base-300">
        <div className="items-center  grid-flow-col">

          <img className='h-16 w-16 border border-sky-950 rounded-full mr-2' src={img} alt="" />
          <p className='italic  font-bold'>Srbnb <br />Created By Rafia Binte Rashed at 2023</p>
        </div>
